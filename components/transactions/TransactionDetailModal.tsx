    ...
    <Dialog open={!!transaction} onOpenChange={onClose}>
      <DialogContent>
        ...
        <div className="flex flex-col-reverse sm:flex-row sm:justify-between gap-2 mt-6">
            <Button variant="destructive" onClick={handleDelete} className="w-full sm:w-auto justify-center"><Trash2 className="w-4 h-4 mr-2"/>Excluir</Button>
            <div className="flex flex-col-reverse sm:flex-row gap-2 w-full sm:w-auto">
                <Button variant="ghost" onClick={onClose} className="w-full sm:w-auto justify-center">Fechar</Button>
                <Button onClick={handleEdit} className="w-full sm:w-auto justify-center"><Edit3 className="w-4 h-4 mr-2"/>Editar</Button>
            </div>
        </div>
      </DialogContent>
    </Dialog>
