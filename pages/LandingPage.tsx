    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 to-slate-900 text-slate-200 dark">
      ...
      <section className="text-center py-24 px-4 max-w-5xl mx-auto">
        ...
        <div className="flex justify-center mb-10">
          <img src="https://placehold.co/800x500/1e293b/4f46e5/png?text=Gestorama+App" alt="Preview do app Gestorama" className="rounded-3xl shadow-2xl w-full max-w-md border border-slate-700/40" />
        </div>
